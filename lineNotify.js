...
function lineNotify () {
    const token = "v1JAg6FCmTjAvxCYhMTEOMrKtTPV5LIHLqLeJpyGdkm";
    
    // 使用 form-data 傳遞資料
    const form_data = new FormData();
    form_data.append("message", 'JF150 Black Size:2 補貨了 https://store.isseymiyake.com/c/hp_all_all/hp_basic_all/HP55JF150');
